"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const e=require("vue"),p=require("../node_modules/.pnpm/primevue@4.3.6_vue@3.5.17_typescript@5.6.3_/node_modules/primevue/button/index.cjs.js"),i=require("./utils.cjs.js"),o=e.defineComponent({__name:"VoltButton",setup(d){const a=e.ref({root:`inline-flex cursor-pointer select-none items-center justify-center overflow-hidden relative
    ...
    `,loadingIcon:"",icon:"p-right:order-1 p-bottom:order-2",label:`font-semibold p-icon-only:invisible p-icon-only:w-0
        p-small:text-xs p-large:text-base`,pcBadge:{root:"min-w-4 h-4 leading-4 bg-primary-contrast rounded-full text-primary text-xs font-bold"}});return(r,l)=>(e.openBlock(),e.createBlock(e.unref(p.default),{unstyled:"",pt:a.value,"pt-options":{mergeProps:e.unref(i.ptViewMerge)}},e.createSlots({_:2},[e.renderList(r.$slots,(s,t)=>({name:t,fn:e.withCtx(n=>[e.renderSlot(r.$slots,t,e.normalizeProps(e.guardReactiveProps(n??{})))])}))]),1032,["pt","pt-options"]))}});exports.default=o;
