import { defineComponent as C, computed as o, withDirectives as a, openBlock as r, createElementBlock as c, normalizeClass as p, createElementVNode as t, vShow as u } from "vue";
const m = ["fill"], f = ["fill"], h = /* @__PURE__ */ C({
  __name: "RuneSpinner",
  props: {
    color: { default: "slate" },
    size: {},
  ...
  setup(i) {
    ...
    return (e, d) => a((r(), c("svg", {
      class: p(["animate-spin", n.value]),
      viewBox: "0 0 25 24",
      fill: "none",
